...
$dep = $_POST['dep'];
        ...
        $insert = "insert into pessoa values($cpf,'$nome',$idade,'$datanasc','$sexo','$email','$senha','$cidade',$uf,'$telefone','1')";
...
if($result and $result2){
            ...
            echo'<a href="../funcoes/funcoesgerente.php?op='.$op.'" class="btn" style="text-align: center; color:white; text-decoration: none; line-height: 100%;">Voltar</a>';
            echo"</div>";
}
